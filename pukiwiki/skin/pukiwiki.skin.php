...
<script async src="https://www.googletagmanager.com/gtag/js?id=UA-176921702-1"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'UA-176921702-1');
</script>
...
<div id="header">
<!--
 <a href="<?php echo $link['top'] ?>"><img id="logo" src="<?php echo IMAGE_DIR . $image['logo'] ?>" width="80" height="80" alt="[EU4 Wiki]" title="[EU4 Wiki]" /></a>
-->
